...
OUTPUT_PATH = "src/mcp_server_twelve_data/tools.py"

EXCLUDED_TOOLS = ["GetMarketState", "GetIpoCalendar"]
...
def collect_operations(paths, spec):
    ...
    for path in paths:
        ...
        for method, details in path_item.items():
            ...
            if not op_id or op_id in seen or op_id in EXCLUDED_TOOLS:
                continue
            seen.add(op_id)
...
def main():
    ...
    print(f"[INFO] Excluded {len(EXCLUDED_TOOLS)} tools: {', '.join(EXCLUDED_TOOLS)}")
